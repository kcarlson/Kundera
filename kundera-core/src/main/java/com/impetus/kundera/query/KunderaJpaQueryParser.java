 ...
 */
public class KunderaJpaQueryParser implements KunderaQueryParser
{
    ...
    private boolean isKeyword(String token)
    {
        ...
        // lowercase form
        for (int i = 0; i < KunderaJpaQuery.SINGLE_STRING_KEYWORDS.length; i++)
        {
            if (token.equalsIgnoreCase(KunderaJpaQuery.SINGLE_STRING_KEYWORDS[i]))
            {
                return true;
            }
        }
